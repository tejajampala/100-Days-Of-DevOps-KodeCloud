...
1. Modify `sshd_config` and restart sshd `service`
2. Use sed - stream editor to find and replace
   (s - search, g - global, -i - replaces the value or else just shows output in the editor)
