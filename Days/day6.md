...
3. Start crond service
    ...
    <img width="937" height="730" alt="image" src="https://github.com/user-attachments/assets/4acccef5-95f4-42b7-9ce9-04bf026f27cf" />
...
4. Create cron schedule:
    ...
    */5 * * * * echo hello > /tmp/cron_text
    ...
    <img width="962" height="701" alt="image" src="https://github.com/user-attachments/assets/8beeaea4-4e46-4ce6-b993-bdcebf5ab71a" />
